namespace Application.eGreeting.Models
{
    ...
    public class DBInit : DropCreateDatabaseIfModelChanges<eGreetingDB>
    {
        protected override void Seed(eGreetingDB context)
        {
            ...
            {
                new Card { NameCard="Birthday-01",Category="Birthday",ImageName="b-image1.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-02",Category="Birthday",ImageName="b-image2.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-03",Category="Birthday",ImageName="b-image3.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-04",Category="Birthday",ImageName="b-image4.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-05",Category="Birthday",ImageName="b-image5.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-06",Category="Birthday",ImageName="b-image6.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-07",Category="Birthday",ImageName="b-image7.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-08",Category="Birthday",ImageName="b-image8.jpg", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-09",Category="Birthday",ImageName="b-image9.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-10",Category="Birthday",ImageName="b-image10.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-11",Category="Birthday",ImageName="b-image11.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-12",Category="Birthday",ImageName="b-image12.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-13",Category="Birthday",ImageName="b-image13.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-14",Category="Birthday",ImageName="b-image14.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-15",Category="Birthday",ImageName="b-image15.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-16",Category="Birthday",ImageName="b-image16.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-17",Category="Birthday",ImageName="b-image17.png", DateCreated = DateTime.Now},
                new Card { NameCard="Birthday-18",Category="Birthday",ImageName="b-image18.png", DateCreated = DateTime.Now},
                
                new Card { NameCard="NewYear-01",Category="NewYear",ImageName="n-image1.png", DateCreated = DateTime.Now},
                new Card { NameCard="NewYear-02",Category="NewYear",ImageName="n-image2.jpg", DateCreated = DateTime.Now},
                new Card { NameCard="NewYear-03",Category="NewYear",ImageName="n-image3.png", DateCreated = DateTime.Now},
                ...
                new Card { NameCard="NewYear-07",Category="NewYear",ImageName="n-image7.png", DateCreated = DateTime.Now},
                new Card { NameCard="NewYear-08",Category="NewYear",ImageName="n-image8.png", DateCreated = DateTime.Now},
                new Card { NameCard="NewYear-09",Category="NewYear",ImageName="n-image9.png", DateCreated = DateTime.Now},
                new Card { NameCard="NewYear-10",Category="NewYear",ImageName="n-image10.png", DateCreated = DateTime.Now},
                ...
                new Card { NameCard="Festival-01",Category="Festival",ImageName="f-image1.png", DateCreated = DateTime.Now},
                ...
                new Card { NameCard="Festival-08",Category="Festival",ImageName="f-image8.png", DateCreated = DateTime.Now},
                new Card { NameCard="Festival-09",Category="Festival",ImageName="f-image9.png", DateCreated = DateTime.Now},
                new Card { NameCard="Festival-10",Category="Festival",ImageName="f-image10.png", DateCreated = DateTime.Now},
                new Card { NameCard="Festival-11",Category="Festival",ImageName="f-image11.png", DateCreated = DateTime.Now},
                new Card { NameCard="Festival-12",Category="Festival",ImageName="f-image12.png", DateCreated = DateTime.Now},
                ...
                new Card { NameCard="Festival-15",Category="Festival",ImageName="f-image15.png", DateCreated = DateTime.Now},
                new Card { NameCard="Festival-16",Category="Festival",ImageName="f-image16.jpg", DateCreated = DateTime.Now},
                new Card { NameCard="Festival-17",Category="Festival",ImageName="f-image17.png", DateCreated = DateTime.Now},
            ...
            {
                new Transaction { Username = "test", Receiver="receiver@gmail.com", Subject = "Happy Birthday my friend", Content ="Hello your 30! Wish you see many many lucky with this old, happiness and healthy", ImageNameTrans="b-image1.png", TimeSend = DateTime.Now, NameCard="Birthday-01" }
            };
